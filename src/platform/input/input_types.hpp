...
enum class KeyAction : U8 { Release = 0, Press = 1, Repeat = 2 };

enum class MouseAction : U8 { Release = 0, Press = 1 };
...
inline ModifierKey operator|(ModifierKey lhs, ModifierKey rhs) {
    return static_cast<ModifierKey>(static_cast<U8>(lhs) | static_cast<U8>(rhs));
}
